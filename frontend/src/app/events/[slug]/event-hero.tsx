        ...
        {hasMedalImage && !isPast ? (
          <>
            ...
            <div className="mt-4 flex flex-col items-center text-center lg:hidden">
              ...
              {/* Title */}
              <h1 className="mt-3 text-[2rem] font-black leading-[1.08] tracking-tight text-foreground xs:text-[2.25rem]">
              ...
              <p className="mt-2 max-w-md text-xs leading-relaxed text-(--muted) sm:text-sm">
                Run anywhere at your pace. Finish your distance and earn India&rsquo;s most prestigious heavyweight 3D finisher medal!
              </p>
              ...
              <div className="relative my-3.5 w-full max-w-xs">
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(ellipse at center, rgba(226, 185, 63, 0.45) 0%, rgba(201, 162, 39, 0.18) 50%, transparent 75%)",
                  }}
                />

                <div className="group relative overflow-hidden rounded-2xl border border-(--gold-line) bg-gradient-to-b from-[#181820] via-[#121216] to-[#0d0d10] p-3.5 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.85),0_0_30px_rgba(201,162,39,0.2)]">
                  {/* Ribbon header */}
                  <div className="flex items-center justify-between border-b border-(--line) pb-2 text-[0.65rem]">
                    <span className="inline-flex items-center gap-1 font-black uppercase tracking-wider text-(--gold)">
                      <Award className="h-3.5 w-3.5" />
                      Official Finisher Medal
                    </span>
                    <span className="inline-flex items-center gap-1 rounded-full bg-(--panel-soft) px-2 py-0.5 font-bold uppercase tracking-wider text-(--muted)">
                      Free Delivery
                    </span>
                  </div>

                  {/* Floating 3D Medal Image */}
                  <div
                    onClick={() => setIsInspectorOpen(true)}
                    className="relative my-2 flex cursor-pointer items-center justify-center py-1"
                  >
                    <motion.div
                      animate={{ y: [0, -4, 0] }}
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-1.5 border-t border-(--line) pt-2 text-center text-[0.65rem]">
                    ...
                    <div className="rounded-lg border border-(--line) bg-(--panel-soft) py-1 px-1">
                      ...
                      <p className="text-[0.6rem] text-(--muted)">Front &amp; Back</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* CTAs */}
              <div className="mt-3.5 flex w-full max-w-sm flex-col gap-2">
                <RegisterCta
                  className="btn-gold !py-3.5 !px-6 text-sm font-black rounded-xl shadow-xl shadow-(--gold)/20 hover:shadow-(--gold)/35 transition-all text-center justify-center w-full"
              ...
              {event.endsAt ? (
                <div className="mt-3 flex justify-center">
                  <span className="glass-pill inline-flex items-center gap-2 rounded-full px-3.5 py-1 text-xs font-bold text-foreground">
              ...
              <div className="mt-4 flex items-center justify-center gap-2.5">
                <div className="flex -space-x-2">
                  {[
                    ...
                    <img
                      ...
                      src={src}
                      alt="Runner avatar"
                      className="h-7 w-7 rounded-full border-2 border-(--background) object-cover shadow-sm"
                    />
                  ))}
                </div>
                <div className="flex items-center gap-1 text-xs font-semibold text-(--muted)">
                  ...
                  <span className="text-[0.7rem]">25,000+ finishers across India</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 hidden lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 lg:items-center sm:mt-12">
              ...
              >
                ...
                <p className="lede mt-4 max-w-xl text-sm leading-relaxed sm:text-lg lg:max-w-none text-(--muted)">
                ...
                {/* CTAs */}
                <div className="mt-6 flex flex-row items-center justify-start gap-2.5">
                  <RegisterCta
